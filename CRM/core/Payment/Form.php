...
/**
 ...
 static function buildEbsForm($form, $useRequired = FALSE) {
  	//echo "<pre>";print_r($form);echo "</pre>";
	    ...
	    $form->_paymentFields["billing_country_id-{$bltID}"] = array(
	     ...
	     $form->_paymentFields["billing_phone-{$bltID}"] = array(
	      'htmlType' => 'text',
	      'name' => "billing_phone-{$bltID}",
	      'title' => ts('Phone'),
	      'cc_field' => TRUE,
	      'attributes' => array('size' => 30, 'maxlength' => 12, 'autocomplete' => 'off'),
	      'is_required' => TRUE,
	    );
